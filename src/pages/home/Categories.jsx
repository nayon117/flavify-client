  ...
  return (
    <div className="section-container py-16">
      ...
      <div className='flex flex-col md:flex-row gap-8 flex-wrap justify-around items-center mt-12'>
        {
          categoriesItems?.map((item, idx) => <div key={idx} className='shadow-md rounded-md bg-white py-6 px-5 mx-auto text-center cursor-pointer hover:-translate-y-4 duration-300 transition-all'>
            <div>
              <img src={item.img} alt="" className='p-5 bg-green rounded-md w-28 h-28'/>
            </div>
